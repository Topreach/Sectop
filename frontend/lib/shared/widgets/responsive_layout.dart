...
/// Wrapper widget used in MaterialApp.builder to provide responsive context.
/// Adds safe area handling and adaptive constraints for tablet/desktop.
class ResponsiveWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // On tablet/desktop, constrain max width for readability
          ...
          return Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: constraints.maxWidth >= Breakpoints.desktop
                    ? [
                        BoxShadow(
